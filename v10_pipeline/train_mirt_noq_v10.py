...
from common import output_data_root, project_root, v10_dataset_dir, write_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train modified EduCDM no-Q MIRT for V10 feature estimation.")
...
def main() -> None:
    ...
    output_dir = args.output_dir or (v10_dir / "mirt" / "outputs")
    ...
    write_json(
        output_dir / "mirt_export_manifest.json",
        {
            ...
            "version": "v10_graph_subset_no_q_mirt",
            "input_dir": input_dir,
    ...
    print(f"saved V10 MIRT outputs: {output_dir}")
