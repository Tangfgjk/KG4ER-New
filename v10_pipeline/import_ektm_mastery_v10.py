...
from common import output_data_root, read_json, v10_dataset_dir, write_json, write_matrix_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Import strict EKTM_mirt know_output as V10 stu2know_mastery.json.")
...
def main() -> None:
    ...
    print(f"imported V10 EKTM_mirt mastery: {target}")
