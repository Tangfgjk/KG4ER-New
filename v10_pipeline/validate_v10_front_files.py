...
def validate_dataset(dataset: str, data_root: Path) -> dict[str, Any]:
    graph_dir = v10_dataset_dir(dataset, data_root)
    errors: list[str] = []
    warnings: list[str] = []
    required = [
        "entities.dict",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate V10 front files after regeneration.")
...
def main() -> None:
    ...
    output_file = args.output_file or (args.output_data_root / "v10_validation_report.json")
