...
def build_exercise_features(
    ...
    for idx in range(exercise_count):
        ...
        features[f"ex{idx}"] = {
            ...
            "feature_source": "v10_graph_subset_EduCDM_modified_no_q_MIRT",
        }
    return features
...
def build_learner_features(
    ...
    if mastery.ndim != 2 or mastery.shape[0] != learner_count:
        raise ValueError(
            "mastery matrix must align with V10 graph learners: "
    ...
    for idx in range(learner_count):
        ...
        features[f"uid{idx}"] = {
            ...
            "feature_source": "v10_MIRT_theta_plus_V10_mastery",
        }
    return features
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Export V10 MIRT-derived feature files for SemanticConvE.")
...
def main() -> None:
    ...
    input_dir = args.input_dir or (v10_dir / "mirt" / "inputs")
    mirt_output_dir = args.mirt_output_dir or (v10_dir / "mirt" / "outputs")
    output_feature_dir = args.output_feature_dir or (v10_dir / "semantic_kg_features")
    mastery_file = args.mastery_file or (v10_dir / "stu2know_mastery.json")
    ...
    write_json(
        output_feature_dir / "feature_generation_manifest.json",
        {
            ...
            "feature_version": "v10_graph_subset_mirt_features",
