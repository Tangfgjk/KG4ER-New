...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train V10 PKC-DKT and export stu2know_seq.json.")
...
def main() -> None:
    ...
    (v10_dir / "stu2know_seq.json").write_text((output_dir / "stu2know_seq.json").read_text(encoding="utf-8"), encoding="utf-8")
    write_json(
        output_dir / "pkc_dkt_manifest.json",
        {
            "dataset": args.dataset,
            "source": "V10 PKC-DKT trained locally for next-knowledge-concept occurrence prediction",
