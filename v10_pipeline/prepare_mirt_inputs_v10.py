...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare V10 MIRT inputs aligned to ER graph learners and exercise ids.")
...
def main() -> None:
    ...
    manifest = {
        ...
        "version": "v10_graph_subset_mirt_inputs",
    ...
    print(f"created V10 MIRT inputs: {input_dir}")
