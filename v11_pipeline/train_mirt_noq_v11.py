...
from common import output_data_root, project_root, v11_dataset_dir, write_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train modified EduCDM no-Q MIRT for V11 feature estimation.")
...
def main() -> None:
    ...
    output_dir = args.output_dir or (v11_dir / "mirt" / "outputs")
    ...
    write_json(
        output_dir / "mirt_export_manifest.json",
        {
            ...
            "version": "v11_graph_subset_no_q_mirt",
            "input_dir": input_dir,
    ...
    print(f"saved V11 MIRT outputs: {output_dir}")
