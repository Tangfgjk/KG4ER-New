...
from build_v13_graph import exercise_forgetting_average
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Regenerate v13 forgetting files with exercise-level average aggregation.")
...
def main() -> None:
    ...
    print(f"saved v13 forgetting files: {forget_dir}")
