...
from common import output_data_root, read_json, v13_dataset_dir, write_json, write_matrix_json
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Import strict EKTM_mirt know_output as v13 stu2know_mastery.json.")
...
def main() -> None:
    ...
    print(f"imported v13 EKTM_mirt mastery: {target}")
