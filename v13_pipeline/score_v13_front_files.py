...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate v13 front-file recommendation distances before SemanticConvE training."
    )
...
def main() -> None:
    ...
    # evaluate_recommendations ranks larger scores first; v13 front files store smaller-is-better distances.
    ...
    try:
        ...
        sys.argv = old_argv
    print(f"saved v13 front oracle scores: {score_file}")
    print(f"saved v13 front oracle metrics: {out_dir}")
